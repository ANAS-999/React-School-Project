...
const ANIMES = [
  ...
  },
  {
    ...
    image:
      "https://images.wall-art.de/format:webp/q:90/rs:fit:332:/_img/out/pictures/master/product/1/66601.jpg",
    rating: 9.0,
    year: 2013,
    genre: "Action",
    description:
      "Humanity fights giant humanoid creatures threatening extinction",
  },
  {
    id: "3",
    title: "One Piece",
    image:
      "https://preview.redd.it/what-is-it-that-makes-one-piece-so-popular-v0-0u2aefrzacmc1.jpeg?auto=webp&s=43de34e87b70807ecd9f720e44ca6993656f7258",
    rating: 8.7,
    year: 1999,
    genre: "Adventure",
