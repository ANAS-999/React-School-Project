...
function DiscoverHero({ gameCount, movieCount, isSearching }: DiscoverHeroProps) {
  ...
  return (
    <section className="discover-hero" ref={heroRef}>
      ...
      <div className="floating-icons">
        ...
        <div className="icon-wrapper floating-icon-5">
          <Icon icon="fa-film" />
        </div>
      </div>
