...
function MovieHero({ movieCount = 0, isSearching = false }: MovieHeroProps) {
      ...
      <div className="container discover-hero-container">
        <div className="discover-hero-content">
          ...
          <p className="discover-subtitle">
            Browse top-rated and trending movies. Find classics, new releases, and hidden gems.
          </p>
        </div>
        ...
        <div className="discover-stats-wrapper">
          <div className="discover-stats glass-panel">
            <div className="stat">
              ...
              <span className="stat-label">{isSearching ? "Found Movies" : "Top Movies"}</span>
            </div>
